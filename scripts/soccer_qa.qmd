...
# url_stats_match <- paste0('https://www.fotmob.com/api/matchDetails?matchId=', 4205546)
...
# print(response.status_code)  # Verifica si devuelve 200
# print(response.text)  # Ver el JSON de la respuesta
