...
Graf3=ggplot(equipos, aes(x = xG, y = Goles), col.axis = "red") +
...
animate(anim, nframes =150 ,
        renderer = gifski_renderer("bet6.gif"),
        heigh=1080, width=1000)
...
animate(anim, nframes =150 ,
        renderer = gifski_renderer("bet1canva.gif"),
        heigh=750, width=750)
