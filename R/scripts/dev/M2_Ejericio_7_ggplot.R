...
p<-ggplot(Ejercicio,aes(year,xG)) +
  geom_area() +
  scale_x_continuous(breaks = 2014:2020) +
  labs(x = "Temporada", y = "Goles Esperados (xG)",
       title = "Evolución del promedio de xG del Real Madrid por temporada",
...
p<-ggplot(Ejercicio,aes(xG)) +
  geom_density() +
  labs(y = "Densidad",
       title = "Distribución de denisdad de xG del Real Madrid por partido",
       subtitle = "Temporadas desde 2014 a 2020",
       caption = "Fuente: Understat  Elaborado por: Emrangel") +
  theme_bw() +
  theme(plot.title = element_text(size = 16, face = 4, hjust = 0.5),
...
p<-ggplot(Ejercicio,aes(xG,fill=team_name,colour=team_name)) +
...
p<-ggplot(Ejercicio,aes(year)) +
  geom_bar() +
  scale_x_continuous(breaks = 2014:2020) +
  labs(y = "Numero de partidos",
       x= "Temporada",
       title = "Número de partidos con xG<1 del Real Madrid",
       subtitle = "Temporadas desde 2014 a 2020",
       caption = "Fuente: Understat  Elaborado por: Emrangel"
       ) +
  theme_bw() +
...
p<-ggplot(Ejercicio,aes(year,colour=team_name,fill=team_name)) +
  geom_bar() +
  scale_x_continuous(breaks = 2014:2020) +
  labs(y = "Numero de partidos",
       x= "Temporada",
...
p<-ggplot(Ejercicio,aes(scored,missed,fill=team_name,colour=team_name)) +
  geom_point(size=4) +
...
p<-ggplot(Ejercicio,aes(xG,xGA,fill=team_name,colour=team_name)) +
  geom_point(size=4) +
  labs(y = "xG en contra",
       x = "xG a favor",
...
p<-ggplot(Ejercicio,aes(X,Y*0.7)) +
  geom_bin2d() +
  ...
  theme(plot.title = element_text(size = 16, face = 4, hjust = 0.5),
        ...
        panel.grid.minor =element_line(linetype = c("28")))
ggplotly(p)
# Ejercicio 2.10 Este gráfico no está implementado en plotly. Mirad el error que da
...
p<-ggplot(Ejercicio,aes(minute,total_disparos)) +
  geom_step() +
  labs(y = "Goles",
       x = "Minutos",
...
p<-ggplot(Ejercicio,aes(as.factor(year),xGA)) +
...
p<-ggplot(Ejercicio,aes(as.factor(year),xGA)) +
  ...
  labs(y = "xGA",
       ...
       title = "Distribución de xGA por temporada",
       subtitle = "Temporadas de 2014 a 2020",
       caption = "Fuente: Understat  Elaborado por: Erick Rangel",
       colour = "Equipos:",
       fill = "Equipos:") +
  theme_bw() +
  theme(plot.title = element_text(size = 16, face = 4, hjust = 0.5),
...
p<-ggplot(Ejercicio,aes(as.factor(year),xGA,group=team_name)) +
